...
<head>
	...
	<title>RELATÓRIO NOTAS by Francisley</title>
</head>
...
<a href="index.php" class="w3-display-topleft">
    <i class="fa fa-arrow-circle-left w3-large w3-teal w3-button w3-xxlarge"></i>     
        ...
        <?php
            ...
            $username = "id15109384_ffs";
            $password = "Alice1809*";
            $dbname = "id15109384_pwii";
            ...
            if ($conexao->connect_error) {
                ...
                <h1 class="w3-center w3-teal w3-round-large w3-margin">Relatório de notas</h1>
                ...
                foreach($resultado as $linha) {
                    ...
                    echo '<td>'.$media = ($linha['nota1'] + $linha['nota2'] + $linha['nota3'] + $linha['nota4']) /4;                   
                    echo '</tr>';
