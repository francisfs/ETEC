    ...
    <div class="w3-container w3-round-xxlarge w3-display-middle w3-card-4 w3-third " >
        ...
        <form class="w3-container" action="loginAction.php" method="POST">
            <div class="w3-section">
                ...
                <input class="w3-input w3-border w3-margin-bottom w3-center" type="text" placeholder="Digite o nome" name="txtNome" required>
                <label style="font-weight: bold;">Senha</label>
                <input class="w3-input w3-border w3-center" type="text" placeholder="Digite a Senha" name= "txtSenha" required>
